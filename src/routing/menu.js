  ...
  },
  {
    ...
    items: [
      ...
      { label: "View Courses", perm: pmac(["admin"]), to: "/adminCourses" },
      {
        ...
        items: [
          { label: "Add New Addon", perm: pmac([APP_USER.admin]), to: "/newAddon" },
          { label: "Addons", perm: pmac([APP_USER.admin]), to: "/addons" },
          { label: "Addons Purchases", perm: pmac([APP_USER.admin]), to: "/addonPurchases" },
        ],
      },
      {
        label: "Categories",
