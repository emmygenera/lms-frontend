...
export function Content({ paddingNone = false, className = "", data, children, title, onClick, onClickLabel, onClickFav, onClickColor = "rgba(0, 0, 0, 0.5)", renderItems: RenderItems }) {
  return (
    <div className={"bg-white cs-table-style outline-shadow shadow rad_5. " + (paddingNone ? "" : " p-3 ") + className} style={{ borderRadius: 24 }}>
      {title && (
