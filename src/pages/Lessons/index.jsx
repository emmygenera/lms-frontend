...
const Lessons = (props) => {
  ...
  useEffect(() => {
    ...
    lesson
      ...
      .then(({ data: { data: lessons, total = 10 } }) => {
        setTotal(total);
  ...
  return (
    <>
      ...
      <div className="p-2">
        <PaginatedTable total={total} page={page} pageSize={pageSize} setPage={setPage} setPageSize={setPageSize} columns={columns} loading={loading} data={dataSource} setSelectedRowKeys={setSelectedRowKeys} selectedRowKeys={selectedRowKeys} />
      </div>
    </>
  );
};
