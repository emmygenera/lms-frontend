...
const Instructor = {
  ...
  getPaginated: async (page, pageSize, query) => await http.get(`/instructors/all?pageNo=${page}&pageSize=${pageSize}&query=${query}`),
  ...
  updateOne: async (instructor, insid) => await http.patch(`/users/update/${insid}`, instructor),
